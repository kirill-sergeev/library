                ...
                <c:when test="${not empty books}">
                    <div class="ui center aligned segment">
                        ...
                        <table class="ui red striped table sortable">
                            <thead>
                            <tr>
                                <th ${sort != 'title' ? '' : order == 'desc' ? 'class="sorted descending"' : 'class="sorted ascending"'}>
                                    Title
                                </th>
                                ...
                                <th ${sort != 'publisher_id' ? '' : order == 'desc' ? 'class="sorted descending"' : 'class="sorted ascending"'}>
                                    Publisher
                                </th>
                                <th ${sort != 'publication_date' ? '' : order == 'desc' ? 'class="sorted descending"' : 'class="sorted ascending"'}>
                                    Publication
                                </th>
                                <th ${sort != 'isbn' ? '' : order == 'desc' ? 'class="sorted descending"' : 'class="sorted ascending"'}>
                                    ISBN
                                </th>
                                <c:if test="${user.role == 'ADMIN'}">
                                    <th ${sort != 'quantity' ? '' : order == 'desc' ? 'class="sorted descending"' : 'class="sorted ascending"'}>
                                        Quantity
                                    </th>
                                </c:if>
                                <th ${sort != 'available' ? '' : order == 'desc' ? 'class="sorted descending"' : 'class="sorted ascending"'}>
                                    Available
                                </th>
                            ...
                            <tr>
                                <th colspan="2">
                                    <c:if test="${not empty author}"><c:set var="group" scope="page"
                                                                            value="author=${author}&"/></c:if>
                                    <c:if test="${not empty genre}"><c:set var="group" scope="page"
                                                                           value="genre=${genre}&"/></c:if>
                                    <c:if test="${not empty publisher}"><c:set var="group" scope="page"
                                                                               value="publisher=${publisher}&"/></c:if>
